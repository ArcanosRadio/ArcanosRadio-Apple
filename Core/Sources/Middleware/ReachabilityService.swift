...
extension ReachabilityStatus: RawRepresentable, Codable {
    public init?(rawValue: Int) {
        switch rawValue {
        case 0: self = .unreachable
        case 1: self = .reachable(viaWiFi: false)
        case 2: self = .reachable(viaWiFi: true)
        default: return nil
        }
    }
    ...
    public var rawValue: Int {
        ...
        case let .reachable(viaWiFi): return viaWiFi ? 2 : 1
        }
    }
}
